...
public class GraphicEditor5_12
{
    private Shape head, tail;
    private Scanner sc;
    public GraphicEditor5_12()
    {
        head = null;  // 시작 노드
        tail = null; // 끝 노드
    ...
    { // 노드 삽입
        ...
        if(head == null) // head가 아무것도 안가르킬때
        {
            head = grapic; // 새로운 노드를 가르킴
            tail = grapic;
        }
        else {
    ...
    {
        GraphicEditor5_12 editor = new GraphicEditor5_12();
        editor.run();
    }
}
